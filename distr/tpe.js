...
/**
   ...
   */const t=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,e=Symbol(),s=new Map;class i{constructor(t,s){if(this._$cssResult$=!0,s!==e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){let e=s.get(this.cssText);return t&&void 0===e&&(s.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const r=t=>new i("string"==typeof t?t:t+"",e),o=(t,...s)=>{const r=1===t.length?t[0]:s.reduce(((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1]),t[0]);return new i(r,e)},n=(e,s)=>{t?e.adoptedStyleSheets=s.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):s.forEach((t=>{const s=document.createElement("style"),i=window.litNonce;void 0!==i&&s.setAttribute("nonce",i),s.textContent=t.cssText,e.appendChild(s)}))},a=t?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return r(e)})(t):t
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */;var l,d;const h={toAttribute(t,e){switch(e){case Boolean:t=t?"":null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch(t){s=null}}return s}},c=(t,e)=>e!==t&&(e==e||t==t),u={attribute:!0,type:String,converter:h,reflect:!1,hasChanged:c};class p extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(t){var e;null!==(e=this.l)&&void 0!==e||(this.l=[]),this.l.push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach(((e,s)=>{const i=this._$Eh(s,e);void 0!==i&&(this._$Eu.set(i,s),t.push(i))})),t}static createProperty(t,e=u){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const s="symbol"==typeof t?Symbol():"__"+t,i=this.getPropertyDescriptor(t,s,e);void 0!==i&&Object.defineProperty(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){return{get(){return this[e]},set(i){const r=this[t];this[e]=i,this.requestUpdate(t,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||u}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,e=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const s of e)this.createProperty(s,t[s])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const t of s)e.unshift(a(t))}else void 0!==t&&e.push(a(t));return e}static _$Eh(t,e){const s=e.attribute;return!1===s?void 0:"string"==typeof s?s:"string"==typeof t?t.toLowerCase():void 0}o(){var t;this._$Ev=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Ep(),this.requestUpdate(),null===(t=this.constructor.l)||void 0===t||t.forEach((t=>t(this)))}addController(t){var e,s;(null!==(e=this._$Em)&&void 0!==e?e:this._$Em=[]).push(t),void 0!==this.renderRoot&&this.isConnected&&(null===(s=t.hostConnected)||void 0===s||s.call(t))}removeController(t){var e;null===(e=this._$Em)||void 0===e||e.splice(this._$Em.indexOf(t)>>>0,1)}_$Ep(){this.constructor.elementProperties.forEach(((t,e)=>{this.hasOwnProperty(e)&&(this._$Et.set(e,this[e]),delete this[e])}))}createRenderRoot(){var t;const e=null!==(t=this.shadowRoot)&&void 0!==t?t:this.attachShadow(this.constructor.shadowRootOptions);return n(e,this.constructor.elementStyles),e}connectedCallback(){var t;void 0===this.renderRoot&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),null===(t=this._$Em)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostConnected)||void 0===e?void 0:e.call(t)}))}enableUpdating(t){}disconnectedCallback(){var t;null===(t=this._$Em)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostDisconnected)||void 0===e?void 0:e.call(t)}))}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$Eg(t,e,s=u){var i,r;const o=this.constructor._$Eh(t,s);if(void 0!==o&&!0===s.reflect){const n=(null!==(r=null===(i=s.converter)||void 0===i?void 0:i.toAttribute)&&void 0!==r?r:h.toAttribute)(e,s.type);this._$Ei=t,null==n?this.removeAttribute(o):this.setAttribute(o,n),this._$Ei=null}}_$AK(t,e){var s,i,r;const o=this.constructor,n=o._$Eu.get(t);if(void 0!==n&&this._$Ei!==n){const t=o.getPropertyOptions(n),a=t.converter,l=null!==(r=null!==(i=null===(s=a)||void 0===s?void 0:s.fromAttribute)&&void 0!==i?i:"function"==typeof a?a:null)&&void 0!==r?r:h.fromAttribute;this._$Ei=n,this[n]=l(e,t.type),this._$Ei=null}}requestUpdate(t,e,s){let i=!0;void 0!==t&&(((s=s||this.constructor.getPropertyOptions(t)).hasChanged||c)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),!0===s.reflect&&this._$Ei!==t&&(void 0===this._$ES&&(this._$ES=new Map),this._$ES.set(t,s))):i=!1),!this.isUpdatePending&&i&&(this._$Ev=this._$EC())}async _$EC(){this.isUpdatePending=!0;try{await this._$Ev}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach(((t,e)=>this[e]=t)),this._$Et=void 0);let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),null===(t=this._$Em)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostUpdate)||void 0===e?void 0:e.call(t)})),this.update(s)):this._$ET()}catch(t){throw e=!1,this._$ET(),t}e&&this._$AE(s)}willUpdate(t){}_$AE(t){var e;null===(e=this._$Em)||void 0===e||e.forEach((t=>{var e;return null===(e=t.hostUpdated)||void 0===e?void 0:e.call(t)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ev}shouldUpdate(t){return!0}update(t){void 0!==this._$ES&&(this._$ES.forEach(((t,e)=>this._$Eg(e,this[e],t))),this._$ES=void 0),this._$ET()}updated(t){}firstUpdated(t){}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
var g,m;p.finalized=!0,p.elementProperties=new Map,p.elementStyles=[],p.shadowRootOptions={mode:"open"},null===(l=globalThis.reactiveElementPolyfillSupport)||void 0===l||l.call(globalThis,{ReactiveElement:p}),(null!==(d=globalThis.reactiveElementVersions)&&void 0!==d?d:globalThis.reactiveElementVersions=[]).push("1.0.0");const b=globalThis.trustedTypes,v=b?b.createPolicy("lit-html",{createHTML:t=>t}):void 0,f=`lit$${(Math.random()+"").slice(9)}$`,y="?"+f,x=`<${y}>`,w=document,_=(t="")=>w.createComment(t),A=t=>null===t||"object"!=typeof t&&"function"!=typeof t,$=Array.isArray,k=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,E=/-->/g,S=/>/g,C=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,M=/'/g,T=/"/g,V=/^(?:script|style|textarea)$/i,P=(t=>(e,...s)=>({_$litType$:t,strings:e,values:s}))(1),O=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),L=new WeakMap,I=w.createTreeWalker(w,129,null,!1),R=(t,e)=>{const s=t.length-1,i=[];let r,o=2===e?"<svg>":"",n=k;for(let e=0;e<s;e++){const s=t[e];let a,l,d=-1,h=0;for(;h<s.length&&(n.lastIndex=h,l=n.exec(s),null!==l);)h=n.lastIndex,n===k?"!--"===l[1]?n=E:void 0!==l[1]?n=S:void 0!==l[2]?(V.test(l[2])&&(r=RegExp("</"+l[2],"g")),n=C):void 0!==l[3]&&(n=C):n===C?">"===l[0]?(n=null!=r?r:k,d=-1):void 0===l[1]?d=-2:(d=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?C:'"'===l[3]?T:M):n===T||n===M?n=C:n===E||n===S?n=k:(n=C,r=void 0);const c=n===C&&t[e+1].startsWith("/>")?" ":"";o+=n===k?s+x:d>=0?(i.push(a),s.slice(0,d)+"$lit$"+s.slice(d)+f+c):s+f+(-2===d?(i.push(void 0),e):c)}const a=o+(t[s]||"<?>")+(2===e?"</svg>":"");return[void 0!==v?v.createHTML(a):a,i]};class U{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let r=0,o=0;const n=t.length-1,a=this.parts,[l,d]=R(t,e);if(this.el=U.createElement(l,s),I.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(i=I.nextNode())&&a.length<n;){if(1===i.nodeType){if(i.hasAttributes()){const t=[];for(const e of i.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(f)){const s=d[o++];if(t.push(e),void 0!==s){const t=i.getAttribute(s.toLowerCase()+"$lit$").split(f),e=/([.?@])?(.*)/.exec(s);a.push({type:1,index:r,name:e[2],strings:t,ctor:"."===e[1]?D:"?"===e[1]?j:"@"===e[1]?q:B})}else a.push({type:6,index:r})}for(const e of t)i.removeAttribute(e)}if(V.test(i.tagName)){const t=i.textContent.split(f),e=t.length-1;if(e>0){i.textContent=b?b.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],_()),I.nextNode(),a.push({type:2,index:++r});i.append(t[e],_())}}}else if(8===i.nodeType)if(i.data===y)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=i.data.indexOf(f,t+1));)a.push({type:7,index:r}),t+=f.length-1}r++}}static createElement(t,e){const s=w.createElement("template");return s.innerHTML=t,s}}function H(t,e,s=t,i){var r,o,n,a;if(e===O)return e;let l=void 0!==i?null===(r=s._$Cl)||void 0===r?void 0:r[i]:s._$Cu;const d=A(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==d&&(null===(o=null==l?void 0:l._$AO)||void 0===o||o.call(l,!1),void 0===d?l=void 0:(l=new d(t),l._$AT(t,s,i)),void 0!==i?(null!==(n=(a=s)._$Cl)&&void 0!==n?n:a._$Cl=[])[i]=l:s._$Cu=l),void 0!==l&&(e=H(t,l._$AS(t,e.values),l,i)),e}class z{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:s},parts:i}=this._$AD,r=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:w).importNode(s,!0);I.currentNode=r;let o=I.nextNode(),n=0,a=0,l=i[0];for(;void 0!==l;){if(n===l.index){let e;2===l.type?e=new F(o,o.nextSibling,this,t):1===l.type?e=new l.ctor(o,l.name,l.strings,this,t):6===l.type&&(e=new W(o,this,t)),this.v.push(e),l=i[++a]}n!==(null==l?void 0:l.index)&&(o=I.nextNode(),n++)}return r}m(t){let e=0;for(const s of this.v)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class F{constructor(t,e,s,i){var r;this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cg=null===(r=null==i?void 0:i.isConnected)||void 0===r||r}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=H(this,t,e),A(t)?t===N||null==t||""===t?(this._$AH!==N&&this._$AR(),this._$AH=N):t!==this._$AH&&t!==O&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.S(t):(t=>{var e;return $(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.M(t):this.$(t)}A(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}S(t){this._$AH!==t&&(this._$AR(),this._$AH=this.A(t))}$(t){this._$AH!==N&&A(this._$AH)?this._$AA.nextSibling.data=t:this.S(w.createTextNode(t)),this._$AH=t}T(t){var e;const{values:s,_$litType$:i}=t,r="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=U.createElement(i.h,this.options)),i);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===r)this._$AH.m(s);else{const t=new z(r,this),e=t.p(this.options);t.m(s),this.S(e),this._$AH=t}}_$AC(t){let e=L.get(t.strings);return void 0===e&&L.set(t.strings,e=new U(t)),e}M(t){$(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const r of t)i===e.length?e.push(s=new F(this.A(_()),this.A(_()),this,this.options)):s=e[i],s._$AI(r),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cg=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class B{constructor(t,e,s,i,r){this.type=1,this._$AH=N,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=N}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,i){const r=this.strings;let o=!1;if(void 0===r)t=H(this,t,e,0),o=!A(t)||t!==this._$AH&&t!==O,o&&(this._$AH=t);else{const i=t;let n,a;for(t=r[0],n=0;n<r.length-1;n++)a=H(this,i[s+n],e,n),a===O&&(a=this._$AH[n]),o||(o=!A(a)||a!==this._$AH[n]),a===N?t=N:t!==N&&(t+=(null!=a?a:"")+r[n+1]),this._$AH[n]=a}o&&!i&&this.k(t)}k(t){t===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class D extends B{constructor(){super(...arguments),this.type=3}k(t){this.element[this.name]=t===N?void 0:t}}class j extends B{constructor(){super(...arguments),this.type=4}k(t){t&&t!==N?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}}class q extends B{constructor(t,e,s,i,r){super(t,e,s,i,r),this.type=5}_$AI(t,e=this){var s;if((t=null!==(s=H(this,t,e,0))&&void 0!==s?s:N)===O)return;const i=this._$AH,r=t===N&&i!==N||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==N&&(i===N||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t)}}class W{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){H(this,t)}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
var K,Y,X;null===(g=globalThis.litHtmlPolyfillSupport)||void 0===g||g.call(globalThis,U,F),(null!==(m=globalThis.litHtmlVersions)&&void 0!==m?m:globalThis.litHtmlVersions=[]).push("2.0.0");class G extends p{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,e;const s=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=s.firstChild),s}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=((t,e,s)=>{var i,r;const o=null!==(i=null==s?void 0:s.renderBefore)&&void 0!==i?i:e;let n=o._$litPart$;if(void 0===n){const t=null!==(r=null==s?void 0:s.renderBefore)&&void 0!==r?r:null;o._$litPart$=n=new F(e.insertBefore(_(),t),t,void 0,null!=s?s:{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!1)}render(){return O}}G.finalized=!0,G._$litElement$=!0,null===(K=globalThis.litElementHydrateSupport)||void 0===K||K.call(globalThis,{LitElement:G}),null===(Y=globalThis.litElementPolyfillSupport)||void 0===Y||Y.call(globalThis,{LitElement:G}),(null!==(X=globalThis.litElementVersions)&&void 0!==X?X:globalThis.litElementVersions=[]).push("3.0.0");const J=t=>class extends t{static get styles(){return[super.styles||[],o`             
    ...
    `}_updateAssociatedForm(){this.internals.setFormValue(this.checked?this.value:null)}}tt.register("nn-input-checkbox",gt);class mt extends(Q(G)){static get styles(){return[super.styles,o`
      ...
      `]}static get properties(){return{data:{type:Object,attribute:!1},config:{type:Object,attribute:!1}}}constructor(){super(),this.config={id:"id",countryName:"name",countryCapital:"capital"}}render(){return P`
    <li>${this.data[this.config.countryName]} (Capital: ${this.data[this.config.countryCapital]})</li>
    `}get idValue(){return this.data[this.config.id]}get textValue(){return this.data[this.config.countryName]}stringToData(t){return{[this.config.countryName]:t,valid:!0}}static get PickedElement(){return bt}}tt.register("ee-autocomplete-item-country",mt);class bt extends mt{static get styles(){return[o`
        :host {
          position: relative;
          display: inline-block;
          font-size: 0.9em;
      ...
      <slot></slot>
    `}}tt.register("ee-autocomplete-item-country-view",bt);class vt extends(Q(G)){static get styles(){return[super.styles,o`
        :host {
          display: block;
          padding: 10px;
          border-bottom: 1px solid #ddd;
      ...
      `]}static get properties(){return{data:{type:Object,attribute:!1},config:{type:Object,attribute:!1}}}constructor(){super(),this.config={id:"id",emailName:"name",emailAddress:"email"}}render(){return P`
    ...
    `}}tt.register("ee-autocomplete-item-email-view",ft);class yt extends(Q(G)){static get styles(){return[super.styles,o`
      ...
      `]}static get properties(){return{data:{type:Object,attribute:!1},config:{type:Object,attribute:!1}}}constructor(){super(),this.config={id:"id",path:"name"}}render(){return P`
    ...
    `}_keydownEvent(t){switch(t.key){case"Escape":this.dismissSuggestions();break;case"KeyDown":if(this.suggestions.length){this.shadowRoot.querySelector("#suggestions-elements").firstChild.focus()}}}pickFirst(){this.shadowRoot.querySelector("#suggestions-elements").querySelector("[selected]").click()}focusNext(){if(!this.suggestions.length)return;const t=this.shadowRoot.querySelector("#suggestions-elements");let e=t.querySelector("[selected]")||t.firstElementChild;this.suggestions.length>1&&(e.toggleAttribute("selected",!1),e=e.nextElementSibling||e.previousElementSibling),e&&e.focus()}_picked(t){console.log(t.currentTarget,t.target),!this.informational&&this.targetElement&&t.target.tagName.toLowerCase()===this.itemElement&&(this.targetElement.multiInputApi?this.targetElement.pickedElement(t.target.data):(this.targetElement.value=t.target.textValue,this.targetForId&&(this.targetForId.value=t.target.idValue,this.picked=!0,this.pickedData=t.target.data)),this.dismissSuggestions(),this.targetElement.focus(),this._dispatchPickedEvent())}_dispatchPickedEvent(){if(!this.picked)return;const t=new CustomEvent("input",{composed:!0,bubbles:!0,cancelable:!1,detail:{synthetic:!0,data:this.pickedData}});this.targetElement.dispatchEvent(t)}_jsonCopy(t){return JSON.parse(JSON.stringify(t))}async updated(t){if(!t.has("suggestions"))return;const e=this.shadowRoot.querySelector("#suggestions-elements");if(e.innerHTML="",!this._autocompleteInFlight)if(this.targetElement.multiInputApi&&""===this.targetElement.autocompleteValue)e.toggleAttribute("populated",!1);else{for(const t of this.suggestions){const s=document.createElement(this.itemElement);s.config={...this._jsonCopy(s.config),...this._jsonCopy(this.itemElementConfig)};for(const t of Object.keys(this.itemElementAttributes))s.setAttribute(t,this.itemElementAttributes[t]);s.data=this._jsonCopy(t),s.setAttribute("tabindex",0),e.appendChild(s)}if(1===this.suggestions.length&&!this.targetElement.multiInputApi&&"function"==typeof this.targetElement.setSelectionRange){const t=e.firstChild,s=t.textValue;if(s.toUpperCase().startsWith(this.targetElement.value.toUpperCase())){const e=this.targetElement.value;this.targetElement.value=s,this.targetElement.setSelectionRange(e.length,s.length),this.targetForId&&(this.targetForId.value=t.idValue,this.picked=!0,this.pickedData=t.data,this.displaySingleSuggestion||(this.dismissSuggestions(),this._dispatchPickedEvent()))}}if(this.suggestions.length||e.toggleAttribute("populated",!1),this.suggestions.length){e.toggleAttribute("populated",!0),e.firstChild.toggleAttribute("selected",!0);const t=this._isOutOfViewport(e);t.any&&(console.log(t),console.log(e),e.style.transform=`translateY(${this._calcTranslateY(t.top,t.bottom,e)}px) translateX(${this._calcTranslateX(t.left,t.right)}px)`),e.style.visibility="unset"}}}_calcTranslateY(t,e,s){t=-1*Number(t),e=-1*Number(e);return t+(s&&e?-1*s.offsetHeight+-1*this.targetElement.offsetHeight:0)}_calcTranslateX(t,e){return(t=-1*Number(t))+(e=-1*Number(e))}_isOutOfViewport(t){const e=t.getBoundingClientRect(),s={};return s.top=e.top<0&&e.top,s.left=e.left<0&&e.left,s.bottom=e.bottom>(window.innerHeight||document.documentElement.clientHeight)&&e.bottom-window.innerHeight,s.right=e.right>(window.innerWidth||document.documentElement.clientWidth)&&e.right-window.innerWidth,s.any=!!(s.top||s.left||s.bottom||s.right),s.all=!!(s.top&&s.left&&s.bottom&&s.right),s}toggleSuggestions(){this.suggestions.length?(this.dismissSuggestions(),this.targetElement.value=""):this.openSuggestions()}openSuggestions(){this.targetElement.value=" ",this._inputEvent({})}dismissSuggestions(){this.shadowRoot.querySelector("#suggestions").toggleAttribute("populated",!1),this.suggestions=[]}_handleKeyEvents(t){const e=t.currentTarget.getRootNode().activeElement;if(this.suggestions.length&&e.parentElement)switch(t.key){case"ArrowUp":t.preventDefault(),e.previousElementSibling?e.previousElementSibling.focus():e.parentElement.lastElementChild.focus();break;case"ArrowDown":t.preventDefault(),e.nextElementSibling?e.nextElementSibling.focus():e.parentElement.firstElementChild.focus();break;case"Tab":case"Enter":this._picked(t),t.preventDefault(),this.targetElement.focus();break;case"Escape":this.dismissSuggestions(),this.targetElement.focus()}}async _inputEvent(t){if(console.log(t,this._autocompleteInFlight),0!==t.detail&&t.detail&&t.detail.synthetic)return;const e=this.targetElement;if(!e)return;if(this.dismissSuggestions(),this._autocompleteInFlight)return void(this._attemptedAutocompleteFlight=t);this.targetForId&&(this.targetForId.value="",this.picked=!1,this.pickedData=null),this._autocompleteInFlight=!0;const s=e.autocompleteValue||e.value;if(!s)return this._autocompleteInFlight=!1,void this.dismissSuggestions();const i=this.url+s,r={method:"GET",redirect:"follow"};let o,n=!1;try{o=await fetch(i,r)}catch(t){console.log("ERROR!",t),n=!0}if(n){console.log("Network error!");const t=new CustomEvent("autocomplete-error",{detail:{type:"network"},bubbles:!0,composed:!0});this.dispatchEvent(t)}else if(o.ok){const t=await o.json();this.suggestions=t;const e=new CustomEvent("form-ok",{detail:{response:o},bubbles:!0,composed:!0});this.dispatchEvent(e)}else{console.log("Fetch error!");const t=await o.json(),e=new CustomEvent("autocomplete-error",{detail:{type:"http",response:o,errs:t},bubbles:!0,composed:!0});this.dispatchEvent(e)}if(this._autocompleteInFlight=!1,this._attemptedAutocompleteFlight){const t=this._attemptedAutocompleteFlight;this._attemptedAutocompleteFlight=!1,this._inputEvent(t)}}}tt.register("ee-autocomplete",wt);class _t extends(Q(G)){static get styles(){return[o`
      ...
      `]}static get properties(){return{}}constructor(){super(),this.SOMETHING=!1}connectedCallback(){super.connectedCallback()}render(){return P`
      <slot></slot>
    `}}tt.register("ee-cell",_t);const At=P`<svg class="icon" height="24" viewBox="0 0 24 24" width="24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg>`;class $t extends(Q(G)){static get styles(){return[o`
      ...
      `]}static get properties(){return{opened:{type:Boolean,reflect:!0},backdrop:{type:Boolean,reflect:!0},closeButton:{type:Boolean,attribute:"close-button"},closeThreshold:{type:Number},openThreshold:{type:Number}}}constructor(){super(),this.backdrop=!0,this.closeButton=!0,this.opened=!1,this.closeThreshold=.6,this.openThreshold=.6}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._handleOutsideClick),this.addEventListener("touchstart",this._handleDragStart),this.addEventListener("touchmove",this._handleDrag),this.addEventListener("touchend",this._handleDragEnd),this.addEventListener("mousedown",this._handleDragStart),this.addEventListener("mousemove",this._handleDrag),this.addEventListener("mouseup",this._handleDragEnd)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleOutsideClick),this.removeEventListener("touchstart",this._handleDragStart),this.removeEventListener("touchmove",this._handleDrag),this.removeEventListener("touchend",this._handleDragEnd),this.removeEventListener("mousedown",this._handleDragStart),this.removeEventListener("mousemove",this._handleDrag),this.removeEventListener("mouseup",this._handleDragEnd)}firstUpdated(){this.container=this.shadowRoot.querySelector("div#container")}render(){return P`
      <div id="container">
        ${this.closeButton?P`<button id="close" @click="${this.close}">${At}</button>`:""}
        <nav id="nav">
          <slot></slot>
        </nav>
      </div>
    `}open(){this.opened=!0}close(){this.opened=!1}toggle(){this.opened=!this.opened}_handleOutsideClick(t){this.ignoreNextClick?this.ignoreNextClick=!1:"EE-DRAWER"===t.target.nodeName&&this.close()}_handleDragStart(t){this.dragStart="touchstart"===t.type?t.touches[0].clientX:t.clientX,this.opened||(this.style.width="100vw")}_handleDrag(t){if(void 0===this.dragStart)return;this.dragging=!0,t.preventDefault();const e=("touchmove"===t.type?t.touches[0].clientX:t.clientX)-this.dragStart,s=this.container.getBoundingClientRect().width,i=s-this.openThreshold*s,r=-1*(s-this.closeThreshold*s);return e<r?(this.close(),void this._finishDrag()):e>i?(this.open(),this.ignoreNextClick=!0,void this._finishDrag()):(requestAnimationFrame((()=>{this.container.style.transform=`translateX(calc(${this.opened?"":"-100% +"} ${e}px))`})),!1)}_handleDragEnd(t){this.dragging&&t.preventDefault(),this.dragStart=void 0,this.dragging=!1,this._finishDrag()}_finishDrag(){requestAnimationFrame((()=>{this.container.style.transform="",this.opened||(this.style.width="")}))}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
var kt,Et;tt.register("ee-drawer",$t);const St=globalThis.trustedTypes,Ct=St?St.createPolicy("lit-html",{createHTML:t=>t}):void 0,Mt=`lit$${(Math.random()+"").slice(9)}$`,Tt="?"+Mt,Vt=`<${Tt}>`,Pt=document,Ot=(t="")=>Pt.createComment(t),Nt=t=>null===t||"object"!=typeof t&&"function"!=typeof t,Lt=Array.isArray,It=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Rt=/-->/g,Ut=/>/g,Ht=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,zt=/'/g,Ft=/"/g,Bt=/^(?:script|style|textarea)$/i,Dt=Symbol.for("lit-noChange"),jt=Symbol.for("lit-nothing"),qt=new WeakMap,Wt=Pt.createTreeWalker(Pt,129,null,!1);class Kt{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let r=0,o=0;const n=t.length-1,a=this.parts,[l,d]=((t,e)=>{const s=t.length-1,i=[];let r,o=2===e?"<svg>":"",n=It;for(let e=0;e<s;e++){const s=t[e];let a,l,d=-1,h=0;for(;h<s.length&&(n.lastIndex=h,l=n.exec(s),null!==l);)h=n.lastIndex,n===It?"!--"===l[1]?n=Rt:void 0!==l[1]?n=Ut:void 0!==l[2]?(Bt.test(l[2])&&(r=RegExp("</"+l[2],"g")),n=Ht):void 0!==l[3]&&(n=Ht):n===Ht?">"===l[0]?(n=null!=r?r:It,d=-1):void 0===l[1]?d=-2:(d=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?Ht:'"'===l[3]?Ft:zt):n===Ft||n===zt?n=Ht:n===Rt||n===Ut?n=It:(n=Ht,r=void 0);const c=n===Ht&&t[e+1].startsWith("/>")?" ":"";o+=n===It?s+Vt:d>=0?(i.push(a),s.slice(0,d)+"$lit$"+s.slice(d)+Mt+c):s+Mt+(-2===d?(i.push(void 0),e):c)}const a=o+(t[s]||"<?>")+(2===e?"</svg>":"");return[void 0!==Ct?Ct.createHTML(a):a,i]})(t,e);if(this.el=Kt.createElement(l,s),Wt.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(i=Wt.nextNode())&&a.length<n;){if(1===i.nodeType){if(i.hasAttributes()){const t=[];for(const e of i.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(Mt)){const s=d[o++];if(t.push(e),void 0!==s){const t=i.getAttribute(s.toLowerCase()+"$lit$").split(Mt),e=/([.?@])?(.*)/.exec(s);a.push({type:1,index:r,name:e[2],strings:t,ctor:"."===e[1]?Zt:"?"===e[1]?Qt:"@"===e[1]?te:Jt})}else a.push({type:6,index:r})}for(const e of t)i.removeAttribute(e)}if(Bt.test(i.tagName)){const t=i.textContent.split(Mt),e=t.length-1;if(e>0){i.textContent=St?St.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],Ot()),Wt.nextNode(),a.push({type:2,index:++r});i.append(t[e],Ot())}}}else if(8===i.nodeType)if(i.data===Tt)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=i.data.indexOf(Mt,t+1));)a.push({type:7,index:r}),t+=Mt.length-1}r++}}static createElement(t,e){const s=Pt.createElement("template");return s.innerHTML=t,s}}function Yt(t,e,s=t,i){var r,o,n,a;if(e===Dt)return e;let l=void 0!==i?null===(r=s._$Cl)||void 0===r?void 0:r[i]:s._$Cu;const d=Nt(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==d&&(null===(o=null==l?void 0:l._$AO)||void 0===o||o.call(l,!1),void 0===d?l=void 0:(l=new d(t),l._$AT(t,s,i)),void 0!==i?(null!==(n=(a=s)._$Cl)&&void 0!==n?n:a._$Cl=[])[i]=l:s._$Cu=l),void 0!==l&&(e=Yt(t,l._$AS(t,e.values),l,i)),e}class Xt{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:s},parts:i}=this._$AD,r=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:Pt).importNode(s,!0);Wt.currentNode=r;let o=Wt.nextNode(),n=0,a=0,l=i[0];for(;void 0!==l;){if(n===l.index){let e;2===l.type?e=new Gt(o,o.nextSibling,this,t):1===l.type?e=new l.ctor(o,l.name,l.strings,this,t):6===l.type&&(e=new ee(o,this,t)),this.v.push(e),l=i[++a]}n!==(null==l?void 0:l.index)&&(o=Wt.nextNode(),n++)}return r}m(t){let e=0;for(const s of this.v)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class Gt{constructor(t,e,s,i){var r;this.type=2,this._$AH=jt,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cg=null===(r=null==i?void 0:i.isConnected)||void 0===r||r}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Yt(this,t,e),Nt(t)?t===jt||null==t||""===t?(this._$AH!==jt&&this._$AR(),this._$AH=jt):t!==this._$AH&&t!==Dt&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.S(t):(t=>{var e;return Lt(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.M(t):this.$(t)}A(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}S(t){this._$AH!==t&&(this._$AR(),this._$AH=this.A(t))}$(t){this._$AH!==jt&&Nt(this._$AH)?this._$AA.nextSibling.data=t:this.S(Pt.createTextNode(t)),this._$AH=t}T(t){var e;const{values:s,_$litType$:i}=t,r="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=Kt.createElement(i.h,this.options)),i);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===r)this._$AH.m(s);else{const t=new Xt(r,this),e=t.p(this.options);t.m(s),this.S(e),this._$AH=t}}_$AC(t){let e=qt.get(t.strings);return void 0===e&&qt.set(t.strings,e=new Kt(t)),e}M(t){Lt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const r of t)i===e.length?e.push(s=new Gt(this.A(Ot()),this.A(Ot()),this,this.options)):s=e[i],s._$AI(r),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cg=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class Jt{constructor(t,e,s,i,r){this.type=1,this._$AH=jt,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=jt}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,i){const r=this.strings;let o=!1;if(void 0===r)t=Yt(this,t,e,0),o=!Nt(t)||t!==this._$AH&&t!==Dt,o&&(this._$AH=t);else{const i=t;let n,a;for(t=r[0],n=0;n<r.length-1;n++)a=Yt(this,i[s+n],e,n),a===Dt&&(a=this._$AH[n]),o||(o=!Nt(a)||a!==this._$AH[n]),a===jt?t=jt:t!==jt&&(t+=(null!=a?a:"")+r[n+1]),this._$AH[n]=a}o&&!i&&this.k(t)}k(t){t===jt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class Zt extends Jt{constructor(){super(...arguments),this.type=3}k(t){this.element[this.name]=t===jt?void 0:t}}class Qt extends Jt{constructor(){super(...arguments),this.type=4}k(t){t&&t!==jt?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}}class te extends Jt{constructor(t,e,s,i,r){super(t,e,s,i,r),this.type=5}_$AI(t,e=this){var s;if((t=null!==(s=Yt(this,t,e,0))&&void 0!==s?s:jt)===Dt)return;const i=this._$AH,r=t===jt&&i!==jt||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==jt&&(i===jt||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t)}}class ee{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Yt(this,t)}}null===(kt=globalThis.litHtmlPlatformSupport)||void 0===kt||kt.call(globalThis,Kt,Gt),(null!==(Et=globalThis.litHtmlVersions)&&void 0!==Et?Et:globalThis.litHtmlVersions=[]).push("2.0.0-rc.5");
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const se=P`<svg class="icon" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path d="M13 7h-2v4H7v2h4v4h2v-4h4v-2h-4V7zm-1-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>`;class ie extends(Q(ht(G))){static get styles(){return[super.styles,o`
        :host {
          position: fixed;
          right: 16px;
          left: initial;
      ...
      `]}static get properties(){return{icon:{type:Object},label:{type:String}}}render(){return P`
      <button data-descr=${(t=>null!=t?t:jt)(this.label)} id="native">
        ${this.icon?this.icon:se}
      </button>
    `}}tt.register("ee-fab",ie);class re extends(Q(G)){static get styles(){return[super.styles,o`
      ...
      `]}render(){return P`
      <slot></slot>
    `}}tt.register("ee-fade-in",re);class oe extends(Q(G)){static get styles(){return[super.styles,o`
        :host {
          display: flex;
          box-sizing: border-box;
          width: 100%;
      ...
      `]}render(){return P`
      <slot></slot>
    `}}tt.register("ee-toolbar",oe);const ne=P`<svg class="icon" height="24" viewBox="0 0 24 24" width="24"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"></path></svg>`,ae=P`<svg class="icon" height="24" viewBox="0 0 24 24" width="24"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>`;class le extends(Q(G)){static get styles(){return[super.styles,o`
        :host {
          display: block;
          width: 100%;
        }
      ...
      `]}static get properties(){return{back:{type:Boolean,reflect:!0},menu:{type:Boolean,reflect:!0},backEvent:{type:Function,attribute:"back-event"},menuEvent:{type:Function,attribute:"menu-event"},headerTitle:{type:String,attribute:"header-title"},headerSubtitle:{type:String,attribute:"header-subtitle"}}}constructor(){super(),this.headerTitle=""}menuEvent(){}backEvent(){}render(){return P`
      <div id="header">
        <ee-toolbar class="toolbar">
          <div class="controls">
            ${this.menu?P`<button class="icon" title="Menu" @click="${this._menuEvent}">${ae}</button>`:""}
            ${this.back?P`<button class="icon" title="Back" @click="${this._backEvent}">${ne}</button>`:""}
            <slot name="controls"></slot>
          </div>
          <div header-title>
          ${this.headerTitle?P`
                <h3>${this.headerTitle}</h3>
                <h5>${this.headerSubtitle?P`<div class="subtitle">${this.headerSubtitle}</div>`:""} <slot name="header-subtitle"></slot></h5>
            `:P`
    ...
    `}_menuEvent(){this.dispatchEvent(new CustomEvent("menu-clicked",{bubbles:!0,composed:!0})),this.menuEvent()}_backEvent(){this.dispatchEvent(new CustomEvent("back-clicked",{bubbles:!0,composed:!0})),this.backEvent()}}tt.register("ee-header",le);class de extends(Q(G)){static get styles(){return[super.styles,o`
        :host {
          display: block;
          position: fixed;
          bottom: 0;
    ...
    `}firstUpdated(){this._setOverlay()}_setOverlay(){switch(this.status){case"loaded":case"saved":this.overlayClass="clear";break;case"loading":case"saving":this.overlayClass="overlay-loading";break;case"loading-error":this.overlayClass=this.manageLoadingErrors?"overlay-error":"clear";break;case"saving-error":this.overlayClass=this.manageSavingErrors?"overlay-error":"clear"}}async _overlayClicked(t){if(!this.noReloadOnTap&&(t.stopPropagation(),t.preventDefault(),"loading-error"===this.status||"saving-error"===this.status))if(this.retryMethod)this.retryMethod(this.status,this.lastUrl,this.lastInitObject);else{const t=await this.fetch(this.lastUrl,this.lastInitObject);t.ok&&this.dispatchEvent(new CustomEvent("retry-successful",{detail:{url:this.lastUrl,initObject:this.lastInitObject,fetched:t},composed:!0,bubbles:!1}))}}response(){}messenger(){}async fetch(t,e={}){this.lastUrl=t,this.lastInitObject=e;const s="GET"===(e&&e.method&&e.method.toUpperCase()||"GET");e.url=t,this.status=s?"loading":"saving",this._setOverlay(),this.messenger({status:this.status,url:t,initObject:e,networkElement:this}),this.prefetch(e);try{const i=await fetch(e.url,e),r=i.clone(),o=await r.json();return i.ok?this.status=s?"loaded":"saved":this.status=s?"loading-error":"saving-error",this._setOverlay(),this.messenger({status:this.status,url:t,initObject:e,response:i,networkElement:this}),this.response(i,o,e),i}catch(i){throw this.status=s?"loading-error":"saving-error",this._setOverlay(),this.messenger({status:this.status,url:t,initObject:e,networkElement:this}),this.response(null,null,e),i}}}tt.register("ee-network",he);class ce extends(Q(G)){static get styles(){return[o`
      ...
      `]}static get properties(){return{header:{type:Boolean}}}constructor(){super()}render(){return P`
      <slot></slot>
    `}}tt.register("ee-row",ce);class ue extends(Q(G)){static get styles(){return[super.styles,o`
        :host {
          display: block;
          position: fixed;
          bottom: 0;
    ...
    `}}tt.register("ee-form",me);class be extends(ut(pt(Q(J(ct(ht(G))))))){static get styles(){return[super.styles,o`
      ...
      `]}static get properties(){return{shownValue:{type:String,attribute:!1}}}firstUpdated(){super.firstUpdated(),this.shownValue=this.shadowRoot.querySelector("#native").value}render(){return P`
    ...
    `}_clicked(t){"submit"===this.getAttribute("type")&&(this.form.requestSubmit?this.form.requestSubmit():this.form.submit())}}tt.register("nn-button",ve);class fe extends(ut(pt(ct(ht(G))))){render(){return P`
      <input type="button" id="native">
        <slot></slot>
     `}constructor(){super()}}tt.register("nn-input-button",fe);class ye extends(ut(pt(Q(J(ct(ht(G))))))){render(){return P`
      ${this.ifLabelBefore}
      ${this.ifValidationMessageBefore}
    ...
    `}constructor(){super(),this._boundKeyEventListener=this._eventListener.bind(this)}static get properties(){return{submitOnEnter:{type:Boolean,attribute:"submit-on-enter"}}}_eventListener(t){this.form&&13===t.keyCode&&(1===this.form.elements.length||this.submitOnEnter)&&this.form.submit()}afterSettingProperty(t,e){super.afterSettingProperty(t,e),"value"===t&&this.internals&&this.internals.setFormValue(this.value)}firstUpdated(){super.firstUpdated(),this.addEventListener("keydown",this._boundKeyEventListener);const t=this.shadowRoot.querySelector("#datalist-slot"),e=t&&t.assignedElements()[0],s=e&&e.children;if(s&&s.length){const t=document.createElement("datalist");t.setAttribute("id","_datalist"),this.setAttribute("list","_datalist");for(const e of s){const s=document.createElement("option");s.setAttribute("value",e.getAttribute("value")),t.appendChild(s)}this.shadowRoot.appendChild(t)}}}tt.register("nn-input-text",ye);tt.register("nn-input-color",class extends ye{constructor(){super(),this.inputType="color"}});tt.register("nn-input-date",class extends ye{constructor(){super(),this.inputType="date"}});tt.register("nn-input-datetime-local",class extends ye{constructor(){super(),this.inputType="datetime-local"}});tt.register("nn-input-email",class extends ye{constructor(){super(),this.inputType="email"}});class xe extends(ut(Q(ct(ht(G))))){static get styles(){return[super.styles,o`
      ...
      `]}static get properties(){return{hideNative:{type:Boolean},fileName:{type:String},manyFilesText:{type:String,attribute:"many-files-text"},title:{type:String}}}constructor(){super(),this.manyFilesText="Multiple",this.title="",this.toggleAttribute("as-file",!0)}render(){return P`
      <input type="file" id="native" @change="${this.fileNameChanged}" ?hidden=${this.hideNative} title=${this.title}>
      ${this.fileName}
    `}fileNameChanged(t){const e=this.shadowRoot.querySelector("#native"),s=e.value;e.files.length>1?(this.fileName=this.manyFilesText+` (${e.files.length})`,this.title=Array.from(e.files).map((t=>t.name)).join("\n")):1===e.files.length?(this.fileName=s.slice(s.lastIndexOf("\\")+1),this.title=this.fileName):(this.fileName="",this.title="")}}tt.register("nn-input-file",xe);tt.register("nn-input-month",class extends ye{constructor(){super(),this.inputType="month"}});tt.register("nn-input-number",class extends ye{constructor(){super(),this.inputType="number"}});tt.register("nn-input-password",class extends ye{constructor(){super(),this.inputType="password"}});class we extends(ut(pt(J(Q(ct(ht(G))))))){render(){return P`
      ${this.ifLabelBefore}
      ${this.ifValidationMessageBefore}
      <input as-radio value-source="checked" @change="${this._excludeOthers}" type="radio" id="native" real-time-event="input">
      ${this.ifValidationMessageAfter}
      ${this.ifLabelAfter}
    `}firstUpdated(){super.firstUpdated(),this.setAttribute("type","radio")}_excludeOthers(t){const e=[...this.form.children].filter((t=>t!==this&&!!t.form&&t.getAttribute("name")&&t.getAttribute("name")===this.getAttribute("name")&&("radio"===t.getAttribute("type")||null!==t.getAttribute("as-radio"))));for(const t of e){const e=t.getAttribute("value-source")||"checked";t[e]=!1}this.internals&&this.internals.setFormValue(this.checked?this.value:null)}}tt.register("nn-input-radio",we);class _e extends ye{constructor(){super(),this.inputType="range"}}tt.register("nn-input-range",_e);tt.register("nn-input-search",class extends ye{constructor(){super(),this.type="search"}});class Ae extends(ut(pt(ct(ht(G))))){render(){return P`
      <input @click="${this._formSubmit}" type="submit" id="native">
    `}_formSubmit(t){this.form&&this.form.submit()}}tt.register("nn-input-submit",Ae);tt.register("nn-input-tel",class extends ye{constructor(){super(),this.type="tel"}});tt.register("nn-input-time",class extends ye{constructor(){super(),this.type="time"}});tt.register("nn-input-url",class extends ye{constructor(){super(),this.type="url"}});tt.register("nn-input-week",class extends ye{constructor(){super(),this.type="week"}});class $e extends(Q(J(ht(G)))){get reflectProperties(){return[...super.reflectProperties,...lt]}render(){return P`
      ${this.ifLabelBefore}
      ${this.ifValidationMessageBefore}
      <meter id="native" real-time-event="input"></meter>
      ${this.ifValidationMessageAfter}
      ${this.ifLabelAfter}
    `}}tt.register("nn-meter",$e);class ke extends(Q(J(ht(G)))){static get properties(){return{}}static get styles(){return[o`
      progress {
      ...
      `]}get reflectProperties(){return[...super.reflectProperties,...dt]}render(){return P`
      ${this.ifLabelBefore}
      ${this.ifValidationMessageBefore}
      <progress id="native" real-time-event="input"></progress>
      ${this.ifValidationMessageAfter}
      ${this.ifLabelAfter}
    `}}tt.register("nn-progress",ke);class Ee extends(ut(pt(J(ct(ht(G)))))){get reflectProperties(){return[...super.reflectProperties,...nt]}render(){return P`
      ${this.ifLabelBefore}
      ${this.ifValidationMessageBefore}
      ...
      ${this.ifValidationMessageAfter}
      ${this.ifLabelAfter}
    `}async refreshOptions(t){const e=this.shadowRoot.querySelector("#native"),s=this.shadowRoot.querySelector("#slot");if(!e||!s)return;const i=s.assignedElements();e.innerHTML="";for(const t of i)e.appendChild(t.cloneNode(!0));this.value=this.value}}tt.register("nn-select",Ee);class Se extends(Q(ut(pt(J(ct(ht(G))))))){get reflectProperties(){return[...super.reflectProperties,...at]}render(){return P`
      ${this.ifLabelBefore}
      ${this.ifValidationMessageBefore}
      <textarea name="" id="native" real-time-event="input"></textarea>
      ${this.ifValidationMessageAfter}
      ${this.ifLabelAfter}
    `}}tt.register("nn-textarea",Se);
/**
   * @license
   * Copyright 2019 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const Ce=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Me=Symbol(),Te=new Map;class Ve{constructor(t,e){if(this._$cssResult$=!0,e!==Me)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){let t=Te.get(this.cssText);return Ce&&void 0===t&&(Te.set(this.cssText,t=new CSSStyleSheet),t.replaceSync(this.cssText)),t}toString(){return this.cssText}}const Pe=(t,...e)=>{const s=1===t.length?t[0]:e.reduce(((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1]),t[0]);return new Ve(s,Me)},Oe=Ce?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return(t=>new Ve("string"==typeof t?t:t+"",Me))(e)})(t):t
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */;var Ne,Le;const Ie={toAttribute(t,e){switch(e){case Boolean:t=t?"":null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch(t){s=null}}return s}},Re=(t,e)=>e!==t&&(e==e||t==t),Ue={attribute:!0,type:String,converter:Ie,reflect:!1,hasChanged:Re};class He extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(t){var e;null!==(e=this.l)&&void 0!==e||(this.l=[]),this.l.push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach(((e,s)=>{const i=this._$Eh(s,e);void 0!==i&&(this._$Eu.set(i,s),t.push(i))})),t}static createProperty(t,e=Ue){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const s="symbol"==typeof t?Symbol():"__"+t,i=this.getPropertyDescriptor(t,s,e);void 0!==i&&Object.defineProperty(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){return{get(){return this[e]},set(i){const r=this[t];this[e]=i,this.requestUpdate(t,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||Ue}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,e=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const s of e)this.createProperty(s,t[s])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const t of s)e.unshift(Oe(t))}else void 0!==t&&e.push(Oe(t));return e}static _$Eh(t,e){const s=e.attribute;return!1===s?void 0:"string"==typeof s?s:"string"==typeof t?t.toLowerCase():void 0}o(){var t;this._$Ev=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Ep(),this.requestUpdate(),null===(t=this.constructor.l)||void 0===t||t.forEach((t=>t(this)))}addController(t){var e,s;(null!==(e=this._$Em)&&void 0!==e?e:this._$Em=[]).push(t),void 0!==this.renderRoot&&this.isConnected&&(null===(s=t.hostConnected)||void 0===s||s.call(t))}removeController(t){var e;null===(e=this._$Em)||void 0===e||e.splice(this._$Em.indexOf(t)>>>0,1)}_$Ep(){this.constructor.elementProperties.forEach(((t,e)=>{this.hasOwnProperty(e)&&(this._$Et.set(e,this[e]),delete this[e])}))}createRenderRoot(){var t;const e=null!==(t=this.shadowRoot)&&void 0!==t?t:this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{Ce?t.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((e=>{const s=document.createElement("style"),i=window.litNonce;void 0!==i&&s.setAttribute("nonce",i),s.textContent=e.cssText,t.appendChild(s)}))})(e,this.constructor.elementStyles),e}connectedCallback(){var t;void 0===this.renderRoot&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),null===(t=this._$Em)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostConnected)||void 0===e?void 0:e.call(t)}))}enableUpdating(t){}disconnectedCallback(){var t;null===(t=this._$Em)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostDisconnected)||void 0===e?void 0:e.call(t)}))}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$Eg(t,e,s=Ue){var i,r;const o=this.constructor._$Eh(t,s);if(void 0!==o&&!0===s.reflect){const n=(null!==(r=null===(i=s.converter)||void 0===i?void 0:i.toAttribute)&&void 0!==r?r:Ie.toAttribute)(e,s.type);this._$Ei=t,null==n?this.removeAttribute(o):this.setAttribute(o,n),this._$Ei=null}}_$AK(t,e){var s,i,r;const o=this.constructor,n=o._$Eu.get(t);if(void 0!==n&&this._$Ei!==n){const t=o.getPropertyOptions(n),a=t.converter,l=null!==(r=null!==(i=null===(s=a)||void 0===s?void 0:s.fromAttribute)&&void 0!==i?i:"function"==typeof a?a:null)&&void 0!==r?r:Ie.fromAttribute;this._$Ei=n,this[n]=l(e,t.type),this._$Ei=null}}requestUpdate(t,e,s){let i=!0;void 0!==t&&(((s=s||this.constructor.getPropertyOptions(t)).hasChanged||Re)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),!0===s.reflect&&this._$Ei!==t&&(void 0===this._$ES&&(this._$ES=new Map),this._$ES.set(t,s))):i=!1),!this.isUpdatePending&&i&&(this._$Ev=this._$EC())}async _$EC(){this.isUpdatePending=!0;try{await this._$Ev}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach(((t,e)=>this[e]=t)),this._$Et=void 0);let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),null===(t=this._$Em)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostUpdate)||void 0===e?void 0:e.call(t)})),this.update(s)):this._$ET()}catch(t){throw e=!1,this._$ET(),t}e&&this._$AE(s)}willUpdate(t){}_$AE(t){var e;null===(e=this._$Em)||void 0===e||e.forEach((t=>{var e;return null===(e=t.hostUpdated)||void 0===e?void 0:e.call(t)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ev}shouldUpdate(t){return!0}update(t){void 0!==this._$ES&&(this._$ES.forEach(((t,e)=>this._$Eg(e,this[e],t))),this._$ES=void 0),this._$ET()}updated(t){}firstUpdated(t){}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
var ze,Fe;He.finalized=!0,He.elementProperties=new Map,He.elementStyles=[],He.shadowRootOptions={mode:"open"},null===(Ne=globalThis.reactiveElementPolyfillSupport)||void 0===Ne||Ne.call(globalThis,{ReactiveElement:He}),(null!==(Le=globalThis.reactiveElementVersions)&&void 0!==Le?Le:globalThis.reactiveElementVersions=[]).push("1.0.0");const Be=globalThis.trustedTypes,De=Be?Be.createPolicy("lit-html",{createHTML:t=>t}):void 0,je=`lit$${(Math.random()+"").slice(9)}$`,qe="?"+je,We=`<${qe}>`,Ke=document,Ye=(t="")=>Ke.createComment(t),Xe=t=>null===t||"object"!=typeof t&&"function"!=typeof t,Ge=Array.isArray,Je=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ze=/-->/g,Qe=/>/g,ts=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,es=/'/g,ss=/"/g,is=/^(?:script|style|textarea)$/i,rs=(t=>(e,...s)=>({_$litType$:t,strings:e,values:s}))(1),os=Symbol.for("lit-noChange"),ns=Symbol.for("lit-nothing"),as=new WeakMap,ls=Ke.createTreeWalker(Ke,129,null,!1);class ds{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let r=0,o=0;const n=t.length-1,a=this.parts,[l,d]=((t,e)=>{const s=t.length-1,i=[];let r,o=2===e?"<svg>":"",n=Je;for(let e=0;e<s;e++){const s=t[e];let a,l,d=-1,h=0;for(;h<s.length&&(n.lastIndex=h,l=n.exec(s),null!==l);)h=n.lastIndex,n===Je?"!--"===l[1]?n=Ze:void 0!==l[1]?n=Qe:void 0!==l[2]?(is.test(l[2])&&(r=RegExp("</"+l[2],"g")),n=ts):void 0!==l[3]&&(n=ts):n===ts?">"===l[0]?(n=null!=r?r:Je,d=-1):void 0===l[1]?d=-2:(d=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?ts:'"'===l[3]?ss:es):n===ss||n===es?n=ts:n===Ze||n===Qe?n=Je:(n=ts,r=void 0);const c=n===ts&&t[e+1].startsWith("/>")?" ":"";o+=n===Je?s+We:d>=0?(i.push(a),s.slice(0,d)+"$lit$"+s.slice(d)+je+c):s+je+(-2===d?(i.push(void 0),e):c)}const a=o+(t[s]||"<?>")+(2===e?"</svg>":"");return[void 0!==De?De.createHTML(a):a,i]})(t,e);if(this.el=ds.createElement(l,s),ls.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(i=ls.nextNode())&&a.length<n;){if(1===i.nodeType){if(i.hasAttributes()){const t=[];for(const e of i.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(je)){const s=d[o++];if(t.push(e),void 0!==s){const t=i.getAttribute(s.toLowerCase()+"$lit$").split(je),e=/([.?@])?(.*)/.exec(s);a.push({type:1,index:r,name:e[2],strings:t,ctor:"."===e[1]?gs:"?"===e[1]?ms:"@"===e[1]?bs:ps})}else a.push({type:6,index:r})}for(const e of t)i.removeAttribute(e)}if(is.test(i.tagName)){const t=i.textContent.split(je),e=t.length-1;if(e>0){i.textContent=Be?Be.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],Ye()),ls.nextNode(),a.push({type:2,index:++r});i.append(t[e],Ye())}}}else if(8===i.nodeType)if(i.data===qe)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=i.data.indexOf(je,t+1));)a.push({type:7,index:r}),t+=je.length-1}r++}}static createElement(t,e){const s=Ke.createElement("template");return s.innerHTML=t,s}}function hs(t,e,s=t,i){var r,o,n,a;if(e===os)return e;let l=void 0!==i?null===(r=s._$Cl)||void 0===r?void 0:r[i]:s._$Cu;const d=Xe(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==d&&(null===(o=null==l?void 0:l._$AO)||void 0===o||o.call(l,!1),void 0===d?l=void 0:(l=new d(t),l._$AT(t,s,i)),void 0!==i?(null!==(n=(a=s)._$Cl)&&void 0!==n?n:a._$Cl=[])[i]=l:s._$Cu=l),void 0!==l&&(e=hs(t,l._$AS(t,e.values),l,i)),e}class cs{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:s},parts:i}=this._$AD,r=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:Ke).importNode(s,!0);ls.currentNode=r;let o=ls.nextNode(),n=0,a=0,l=i[0];for(;void 0!==l;){if(n===l.index){let e;2===l.type?e=new us(o,o.nextSibling,this,t):1===l.type?e=new l.ctor(o,l.name,l.strings,this,t):6===l.type&&(e=new vs(o,this,t)),this.v.push(e),l=i[++a]}n!==(null==l?void 0:l.index)&&(o=ls.nextNode(),n++)}return r}m(t){let e=0;for(const s of this.v)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class us{constructor(t,e,s,i){var r;this.type=2,this._$AH=ns,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cg=null===(r=null==i?void 0:i.isConnected)||void 0===r||r}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=hs(this,t,e),Xe(t)?t===ns||null==t||""===t?(this._$AH!==ns&&this._$AR(),this._$AH=ns):t!==this._$AH&&t!==os&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.S(t):(t=>{var e;return Ge(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.M(t):this.$(t)}A(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}S(t){this._$AH!==t&&(this._$AR(),this._$AH=this.A(t))}$(t){this._$AH!==ns&&Xe(this._$AH)?this._$AA.nextSibling.data=t:this.S(Ke.createTextNode(t)),this._$AH=t}T(t){var e;const{values:s,_$litType$:i}=t,r="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=ds.createElement(i.h,this.options)),i);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===r)this._$AH.m(s);else{const t=new cs(r,this),e=t.p(this.options);t.m(s),this.S(e),this._$AH=t}}_$AC(t){let e=as.get(t.strings);return void 0===e&&as.set(t.strings,e=new ds(t)),e}M(t){Ge(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const r of t)i===e.length?e.push(s=new us(this.A(Ye()),this.A(Ye()),this,this.options)):s=e[i],s._$AI(r),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cg=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class ps{constructor(t,e,s,i,r){this.type=1,this._$AH=ns,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=ns}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,i){const r=this.strings;let o=!1;if(void 0===r)t=hs(this,t,e,0),o=!Xe(t)||t!==this._$AH&&t!==os,o&&(this._$AH=t);else{const i=t;let n,a;for(t=r[0],n=0;n<r.length-1;n++)a=hs(this,i[s+n],e,n),a===os&&(a=this._$AH[n]),o||(o=!Xe(a)||a!==this._$AH[n]),a===ns?t=ns:t!==ns&&(t+=(null!=a?a:"")+r[n+1]),this._$AH[n]=a}o&&!i&&this.k(t)}k(t){t===ns?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class gs extends ps{constructor(){super(...arguments),this.type=3}k(t){this.element[this.name]=t===ns?void 0:t}}class ms extends ps{constructor(){super(...arguments),this.type=4}k(t){t&&t!==ns?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}}class bs extends ps{constructor(t,e,s,i,r){super(t,e,s,i,r),this.type=5}_$AI(t,e=this){var s;if((t=null!==(s=hs(this,t,e,0))&&void 0!==s?s:ns)===os)return;const i=this._$AH,r=t===ns&&i!==ns||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==ns&&(i===ns||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t)}}class vs{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){hs(this,t)}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
var fs,ys,xs;null===(ze=globalThis.litHtmlPolyfillSupport)||void 0===ze||ze.call(globalThis,ds,us),(null!==(Fe=globalThis.litHtmlVersions)&&void 0!==Fe?Fe:globalThis.litHtmlVersions=[]).push("2.0.0");class ws extends He{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,e;const s=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=s.firstChild),s}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=((t,e,s)=>{var i,r;const o=null!==(i=null==s?void 0:s.renderBefore)&&void 0!==i?i:e;let n=o._$litPart$;if(void 0===n){const t=null!==(r=null==s?void 0:s.renderBefore)&&void 0!==r?r:null;o._$litPart$=n=new us(e.insertBefore(Ye(),t),t,void 0,null!=s?s:{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!1)}render(){return os}}ws.finalized=!0,ws._$litElement$=!0,null===(fs=globalThis.litElementHydrateSupport)||void 0===fs||fs.call(globalThis,{LitElement:ws}),null===(ys=globalThis.litElementPolyfillSupport)||void 0===ys||ys.call(globalThis,{LitElement:ws}),(null!==(xs=globalThis.litElementVersions)&&void 0!==xs?xs:globalThis.litElementVersions=[]).push("3.0.0");const _s=t=>class extends t{static get stylePatterns(){return{requiredLabelAsterisk:Pe`
        ...
        `}}static get styles(){return[super.styles||[],Pe`
          @-webkit-keyframes fadeIn {
            0%   { opacity: 0; }
            100% { opacity: 1; }
          }
        ...
        `]}};class As extends(_s(et)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete-input-spans",As);class $s extends(_s(gt)){static get properties(){return{labelPosition:{type:String,attribute:!1},validationMessage:{type:String,attribute:!1}}}constructor(){super(),this.labelPosition="after",this.validationMessagePosition="after",this.label=""}firstUpdated(){super.firstUpdated&&super.firstUpdated(),this.shadowRoot.querySelector("label").addEventListener("click",(t=>{t.stopPropagation()}))}static get styles(){return[super.styles,super.stylePatterns.errorMessage,super.stylePatterns.hideNativeWidget,super.stylePatterns.requiredLabelAsterisk,Pe`
        :host {
          display: block;
          position: relative;
          padding-left: 24px;
      ...
      `]}}tt.register("nn-input-checkbox",$s);class ks extends(_s(mt)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete-item-country",ks);class Es extends(_s(bt)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete-item-country-view",Es);class Ss extends(_s(vt)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete-item-email",Ss);class Cs extends(_s(ft)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete-item-email-view",Cs);class Ms extends(_s(yt)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete-item-li",Ms);class Ts extends(_s(xt)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete-item-li-view",Ts);class Vs extends(_s(wt)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-autocomplete",Vs);class Ps extends(_s(_t)){static get styles(){return[super.styles,Pe`
        :host {
          display: flex;
        }

      `]}}tt.register("ee-cell",Ps);class Os extends(_s($t)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-drawer",Os);class Ns extends(_s(ie)){static get styles(){return[super.styles,Pe`
      ...
      `]}}tt.register("ee-fab",Ns);class Ls extends(_s(re)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-fade-in",Ls);class Is extends(_s(le)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-header",Is);class Rs extends(_s(de)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-nav-bar",Rs);class Us extends(_s(he)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-network",Us);class Hs extends(_s(ce)){static get styles(){return[super.styles,Pe`
        :host {
          display: flex;
        }
      `]}}tt.register("ee-row",Hs);class zs extends(_s(ue)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-snack-bar",zs);class Fs extends(_s(pe)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("ee-table",Fs);class Bs extends(_s(ge)){static get styles(){return[super.styles,Pe`
        :host {
      ...
      `]}}tt.register("ee-tabs",Bs);class Ds extends(_s(oe)){static get styles(){return[super.styles,Pe`
        :host {
          display: flex;
        }
      `]}}tt.register("ee-toolbar",Ds);class js extends(_s(me)){static get styles(){return[super.styles,Pe`
        :invalid {
          border: unset;
          border-bottom: var(--mat-input-border, var(--mat-theme-border));
        }
      ...
      `]}}tt.register("en-form",js);class qs extends(_s(be)){static get properties(){return{labelPosition:{type:String,attribute:!1},validationMessage:{type:String,attribute:!1}}}constructor(){super(),this.labelPosition="after",this.validationMessagePosition="after"}static get styles(){return[super.styles,super.stylePatterns.inputField,super.stylePatterns.errorMessage,Pe`
        ::slotted(#range-amount) {}
      `]}}tt.register("en-input-range",qs);class Ws extends(_s(ve)){static get styles(){return[super.styles,Pe`
        :host {
          display: block;
          width: max-content;
          padding: 4px 10px;
      ...
      `]}}tt.register("nn-button",Ws);class Ks extends(_s(fe)){static get styles(){return[super.styles,Pe`
        :host {
          display: inline-block;
          width: fit-content;
          padding: 10px;
      ...
      `]}}tt.register("nn-input-button",Ks);const Ys=t=>class extends t{_observeInput(t){const e=t.currentTarget;this.toggleAttribute("has-value",Xs(e.value))}_observeFocus(t){this.toggleAttribute("has-focus",!0)}_observeBlur(t){this.toggleAttribute("has-focus",!1)}afterSettingProperty(t,e){super.afterSettingProperty(),"value"===t&&this.toggleAttribute("has-value",Xs(e))}firstUpdated(){super.firstUpdated(),this.native.addEventListener("input",this._observeInput.bind(this)),this.native.addEventListener("focus",this._observeFocus.bind(this)),this.native.addEventListener("blur",this._observeBlur.bind(this)),this.toggleAttribute("has-value",Xs(this.value))}};function Xs(t){return"undefined"!==t&&"null"!==t&&""!==t}class Gs extends(_s(Ys(ye))){static get properties(){return{labelPosition:{type:String,attribute:!1},validationMessagePosition:{type:String,attribute:!1}}}constructor(){super(),this.labelPosition="after",this.validationMessagePosition="after"}firstUpdated(){super.firstUpdated();for(const t of["leading","trailing"]){const e=document.createElement("slot");e.setAttribute("name",t),this.shadowRoot.appendChild(e)}}static get styles(){return[super.styles,super.stylePatterns.inputField,super.stylePatterns.inputLabel,super.stylePatterns.floatingLabel,super.stylePatterns.hoverStyle,super.stylePatterns.focusStyle,super.stylePatterns.errorMessage,super.stylePatterns.requiredLabelAsterisk,Pe`
        #native[has-leading] {
          padding-left: 36px;
        }
      ...
      `]}}tt.register("nn-input-text",Gs);class Js extends(_s(Gs)){constructor(){super(),this.inputType="color"}}tt.register("nn-input-color",Js);class Zs extends(_s(Gs)){constructor(){super(),this.inputType="data"}}tt.register("nn-input-date",Zs);class Qs extends(_s(Gs)){constructor(){super(),this.inputType="datetime-local"}}tt.register("nn-input-date-time-local",Qs);class ti extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-email",ti);class ei extends(_s(xe)){static get styles(){return[super.styles,Pe`
        :host {
          display: block;
          min-width: 130px;
        }
      ...
      `]}static get properties(){return{labelPosition:{type:String,attribute:!1},validationMessagePosition:{type:String,attribute:!1},buttonLabel:{type:String,attribute:"button-label"}}}constructor(){super(),this.labelPosition="after",this.validationMessagePosition="after",this.hideNative=!0,this.buttonLabel="Choose File"}render(){return rs`
      ...
      ${this.fileName?this.lit.html`
        ...
        `:""}
      ${this.ifLabelAfter}
    `}_chooseFile(t){this.shadowRoot.querySelector("#native").click()}}tt.register("nn-input-file",ei);class si extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-month",si);class ii extends(_s(Gs)){constructor(){super(),this.inputType="number"}static get styles(){return console.log(super.styles),[super.styles,Pe`
      `]}}tt.register("nn-input-number",ii);class ri extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-password",ri);class oi extends(_s(we)){static get properties(){return{labelPosition:{type:String,attribute:!1},validationMessage:{type:String,attribute:!1}}}constructor(){super(),this.labelPosition="after",this.validationMessagePosition="after",this.label=""}firstUpdated(){super.firstUpdated&&super.firstUpdated(),this.shadowRoot.querySelector("label").addEventListener("click",(t=>{t.stopPropagation()}))}static get styles(){return[super.styles,super.stylePatterns.errorMessage,super.stylePatterns.hideNativeWidget,super.stylePatterns.requiredLabelAsterisk,Pe`
      :host {
        display: inline-block;
        position: relative;
        padding-left: 24px;
      ...
      `]}}tt.register("nn-input-radio",oi);class ni extends(_s(_e)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-range",ni);class ai extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-search",ai);class li extends(_s(Ae)){static get styles(){return[super.styles,Ks.styles,Pe`
      `]}}tt.register("nn-input-submit",li);class di extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-tel",di);class hi extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-time",hi);class ci extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-url",ci);class ui extends(_s(Gs)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-input-week",ui);class pi extends(_s($e)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-meter",pi);class gi extends(_s(ke)){static get styles(){return[super.styles,Pe`
      `]}}tt.register("nn-progress",gi);class mi extends(_s(Ys(Ee))){static get properties(){return{labelPosition:{type:String,attribute:!1},validationMessage:{type:String,attribute:!1}}}constructor(){super(),this.labelPosition="after",this.validationMessagePosition="after"}connectedCallback(){super.connectedCallback(),this.onclick=()=>{this.native.click()}}static get styles(){return[super.styles,super.stylePatterns.inputField,super.stylePatterns.inputLabel,super.stylePatterns.fixedLabel,super.stylePatterns.errorMessage,super.stylePatterns.requiredLabelAsterisk,Pe`
        :host::after {
          position: absolute;
          content: '';
      ...
      `]}}tt.register("nn-select",mi);class bi extends(_s(Ys(Se))){static get properties(){return{labelPosition:{type:String,attribute:!1},validationMessage:{type:String,attribute:!1}}}constructor(){super(),this.labelPosition="after",this.validationMessagePosition="after"}static get styles(){return[super.styles,super.stylePatterns.inputField,super.stylePatterns.inputLabel,super.stylePatterns.floatingLabel,super.stylePatterns.errorMessage,super.stylePatterns.requiredLabelAsterisk,Pe`
        :host {
      ...
      `]}}tt.register("nn-textarea",bi),tt.defineAll()}();
