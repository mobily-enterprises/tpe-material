import { NnInputDateTimeLocal } from 'tpe2/elements/nn-input-date-time-local-class'
import { Shared } from '../mixins/shared.js'
import tpeRegistry from 'tpe2/lib/tpeRegistry'
import { css } from 'lit'

export class NnInputDateTimeLocalMaterial extends Shared(NnInputDateTimeLocal) {
